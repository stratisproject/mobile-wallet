...
import { ConfirmScPage } from './confirm-sc';

describe('ConfirmScPage', () => {
  let fixture: ComponentFixture<ConfirmScPage>;
  let instance;
  let errorsProvider: ErrorsProvider;
  let testBed: typeof TestBed;

  beforeEach(async(() =>
    TestUtils.configurePageTestingModule([ConfirmScPage]).then(testEnv => {
